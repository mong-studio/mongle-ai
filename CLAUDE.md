...
| 작업 종류                                 | 반드시 읽을 문서                                                                                           |
| ----------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| **(신규 합류자) 처음 보는 사람**          | `docs/PRODUCT_SPEC.md` → `docs/FEATURES.md` → `docs/DATA_MODEL.md` (도메인 그룹표) → 관심 피처 `CLAUDE.md` |
...
| 퀘스트 분배 관련                          | `docs/features/quest_generation/CLAUDE.md`, `docs/DATA_MODEL.md` §2, §3.2                                  |
...
| 태그 시스템 관련                          | `docs/DATA_MODEL.md` §3.4, `docs/features/todo/CLAUDE.md` §4.9                                             |
